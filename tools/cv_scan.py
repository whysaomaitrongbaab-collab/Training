...
— ต้องคงที่ข้ามรอบรัน ไม่งั้นเทียบผลระหว่างแขนทดลอง (pass 2 vs 2.4a vs 2.4b) ไม่ได้
...
def cv_hint_text(scan):
    """แปลง scan → บล็อกข้อความแปะท้าย prompt pass 2.4 (2.4a=ข้อความล้วน, 2.4b=คู่ภาพมาร์ค)
