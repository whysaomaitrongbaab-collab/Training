...
## ⚠️ เลขนำหน้าโฟลเดอร์เปลี่ยนแล้ว — 2026-08-28 (ไล่เลขใหม่ 01–38)

โฟลเดอร์ในนี้เคยใช้เลขเดียวกับ `rawjson_ยังไม่ได้แก้ไขโดนคน/` (01–50) จึงมีช่องว่างตรงหลังที่ยังไม่มีคนแก้
(17-21, 25, 28, 38-40, 42, 50) มะขามสั่งให้ไล่เลขใหม่ให้ติดกัน **เฉพาะโฟลเดอร์นี้** — `rawjson_` ยังเป็น 01–50 เหมือนเดิม

**ผลที่ต้องรู้ ก่อนอ่าน log/diary เก่า:**

- **เลขในโฟลเดอร์นี้ไม่ตรงกับ `rawjson_` อีกแล้ว** ตั้งแต่ 17 ขึ้นไป — `json_แก้ไขแล้ว/17` คือ บ้าน_เล็ก_2ชั้น_04
  แต่ `rawjson_ยังไม่ได้แก้ไขโดนคน/17` คือ บ้าน_เล็ก_1ชั้น_15 (คนละหลัง)
- **log / workmen's diary / `สิ่งที่ต้องแก้.md` / edit log ทุกบรรทัดที่เขียนก่อน 2026-08-28 ใช้เลขเก่า** — บันทึกเหล่านั้น
  ไม่ถูกแก้โดยตั้งใจ (มันบันทึกสิ่งที่จริงตอนนั้น) ใช้ตารางข้างล่างแปลง
- **ชื่อบ้าน (`บ้าน_เล็ก_1ชั้น_07` ฯลฯ) ไม่เปลี่ยนเลย** และเป็นตัวระบุที่เชื่อถือได้กว่าเลข — ชื่อไฟล์ JSON,
  `source_image`, และโฟลเดอร์ `image/` ทั้งหมดใช้ชื่อล้วนไม่มีเลข จึงไม่ได้รับผลกระทบ **ถ้าไม่แน่ใจ ให้อ้างด้วยชื่อ**

| เลขเก่า (= เลขใน rawjson_) | เลขใหม่ (ในโฟลเดอร์นี้) | ชื่อบ้าน |
|---|---|---|
| 01 | 01 | บ้าน_เล็ก_1ชั้น_01 |
| 02 | 02 | บ้าน_เล็ก_1ชั้น_02 |
| 03 | 03 | บ้าน_เล็ก_2ชั้น_01 |
| 04 | 04 | บ้าน_เล็ก_2ชั้น_02 |
| 05 | 05 | บ้าน_เล็ก_2ชั้น_03 |
| 06 | 06 | บ้าน_ใหญ่_1ชั้น_01 |
| 07 | 07 | บ้าน_ใหญ่_2ชั้น_01 |
| 08 | 08 | บ้าน_เล็ก_1ชั้น_03 |
| 09 | 09 | บ้าน_เล็ก_1ชั้น_04 |
| 10 | 10 | บ้าน_เล็ก_1ชั้น_05 |
| 11 | 11 | บ้าน_เล็ก_1ชั้น_06 |
| 12 | 12 | บ้าน_ใหญ่_2ชั้น_02 |
| 13 | 13 | บ้าน_เล็ก_2ชั้น_07 |
| 14 | 14 | บ้าน_ใหญ่_2ชั้น_04 |
| 15 | 15 | บ้าน_ใหญ่_2ชั้น_03 |
| 16 | 16 | บ้าน_เล็ก_1ชั้น_09 |
| 22 | 17 | บ้าน_เล็ก_2ชั้น_04 |
| 23 | 18 | บ้าน_เล็ก_1ชั้น_12 |
| 24 | 19 | บ้าน_เล็ก_2ชั้น_08 |
| 26 | 20 | บ้าน_เล็ก_1ชั้น_07 |
| 27 | 21 | บ้าน_ใหญ่_1ชั้น_04 |
| 29 | 22 | บ้าน_ใหญ่_2ชั้น_05 |
| 30 | 23 | บ้าน_เล็ก_1ชั้น_08 |
| 31 | 24 | บ้าน_เล็ก_1ชั้น_11 |
| 32 | 25 | บ้าน_เล็ก_1ชั้น_13 |
| 33 | 26 | บ้าน_เล็ก_2ชั้น_05 |
| 34 | 27 | บ้าน_เล็ก_2ชั้น_06 |
| 35 | 28 | บ้าน_เล็ก_2ชั้น_09 |
| 36 | 29 | บ้าน_เล็ก_2ชั้น_10 |
| 37 | 30 | บ้าน_เล็ก_2ชั้น_13 |
| 41 | 31 | บ้าน_เล็ก_2ชั้น_17 |
| 43 | 32 | บ้าน_เล็ก_2ชั้น_19 |
| 44 | 33 | บ้าน_เล็ก_2ชั้น_20 |
| 45 | 34 | บ้าน_ใหญ่_1ชั้น_02 |
| 46 | 35 | บ้าน_ใหญ่_1ชั้น_03 |
| 47 | 36 | บ้าน_ใหญ่_2ชั้น_06 |
| 48 | 37 | บ้าน_ใหญ่_2ชั้น_07 |
| 49 | 38 | บ้าน_ใหญ่_2ชั้น_08 |

12 หลังที่ยังไม่มีในโฟลเดอร์นี้ (ยังไม่มีคนแก้) ดูได้จาก `rawjson_ยังไม่ได้แก้ไขโดนคน/`: 17 บ้าน_เล็ก_1ชั้น_15 ·
18 บ้าน_ใหญ่_3ชั้น_01 · 19 บ้าน_ใหญ่_3ชั้น_03 · 20 บ้าน_เล็ก_2ชั้น_11 · 21 บ้าน_เล็ก_1ชั้น_10 · 25 บ้าน_ใหญ่_3ชั้น_02 ·
28 บ้าน_เล็ก_2ชั้น_12 · 38 บ้าน_เล็ก_2ชั้น_14 · 39 บ้าน_เล็ก_2ชั้น_15 · 40 บ้าน_เล็ก_2ชั้น_16 · 42 บ้าน_เล็ก_2ชั้น_18 ·
50 บ้าน_เล็ก_1ชั้น_14 (เลขในคอลัมน์นี้เป็นเลข rawjson_)

**หมายเหตุ:** หัวข้อ "บันทึกการแก้ไข" ข้างล่างยังใช้หัวข้อเลขเก่าอยู่ (`### 26บ้าน_เล็ก_1ชั้น_07` ฯลฯ) — ไม่แก้
ด้วยเหตุผลเดียวกับ log: ชื่อบ้านต่อท้ายเลขยังถูกต้องเสมอ ให้ยึดชื่อ
