...
**อัปเดต 2026-08-29:** ไฟล์นี้เขียนไว้ตอน t03 ยังเป็นบ้านของสายพาน ตอนนี้ไม่ใช่แล้ว —
`tune_ai/t04_Purson/` คือบ้านจริง (`pass3_takeoff/` ย้ายไปตั้งแต่ 2026-08-28) วันนี้ย้ายเพิ่ม 2 ไฟล์:
`pass0_classify/` ทั้งโฟลเดอร์ → `t04_Purson/pass0/`, `pass2_used/plan.md` → `t04_Purson/pass2/plan.md`
ไม่ได้แก้ผังโฟลเดอร์ด้านล่างตามให้ครบ (เอกสารนี้ค้างมาหลายจุดอยู่แล้วตั้งแต่ pass4_unused→pass4
เปลี่ยนชื่อ) — ดู `t04_Purson/README.md` สำหรับโครงจริงปัจจุบัน
