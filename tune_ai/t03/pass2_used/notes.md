...
"RB = SR-24 = 2400 ksc, DB = SD-40 = 4000 ksc" — by bar type. They do not say "main bars are X,
stirrups are Y". Record what is printed. `applies_to_dia_mm` takes an array of diameters or the
...
| `fy_main_ksc` | `steel.deformed_bar.fy_ksc` |
| `fy_stirrup_ksc` | `steel.round_bar.fy_ksc` |
