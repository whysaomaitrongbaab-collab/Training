...
>
> ⚠️ **[อัปเดต 2026-07-07] เอกสารสคีมาเต็ม (Makham's Pattern Gen 3, ทุกเวอร์ชัน 3.1/3.2/3.3) ย้ายกลับมาอยู่ repo นี้แล้ว:**
> `training-data/Makham's patter of rawjson20260705.md`
> (เดิมย้ายไป repo Constistant ตั้งแต่ 5 ก.ค. → ย้ายกลับมาที่นี่ 7 ก.ค. — path เดิมที่บรรทัดนี้เคยชี้ไปใน repo Constistant **ไม่มีไฟล์นี้แล้ว**)
>
> ⚠️ **[อัปเดต 2026-07-07] บันทึกงานละเอียดเป็นรายชั่วโมงย้ายมาอยู่ root ของ repo Training แล้ว** (เดิมอยู่ repo Constistant):
> `workmen's_diary/2026-07-05.md`, `2026-07-06.md`, `2026-07-07.md` (ที่ root repo Training ไม่ใช่ใน `training-data/`)
...
- **Constistant** (`c:\00mk\steel project\งานสมบูรณ์\Constistant`) — แอปหลัก (SteelCalc)
- **Training** (`c:\00mk\steel project\training\Training`, github.com/whysaomaitrongbaab-collab/Training) — repo ที่ทำงานจริง มี `training-data/` เก็บ script/config/ผลลัพธ์ extraction ทั้งหมด (รวมทั้งเอกสาร schema design `Makham's patter of rawjson20260705.md`) และ `workmen's_diary/` ที่ root เก็บ log งานละเอียด (**ย้ายมาจาก repo Constistant ทั้งคู่ 7 ก.ค.**)
...
5. ~~ไฟล์เปล่า 0 ไบต์ที่ path เดิมใน repo Training (`training-data/Makham's patter of rawjson20260705.md`)~~ **[แก้แล้ว 2026-07-07: ไฟล์จริงย้ายกลับมาทับ stub เปล่าที่ path นี้แล้ว — ไม่ใช่ปัญหาอีกต่อไป]**
