...
- **ยังไม่ได้ทำ:** สร้าง project จริงใน Label Studio Cloud, import, ทดสอบ UI, publish, เขียน `label-studio-import-*.js` ฝั่งรับผล export กลับ (แปลงเป็น `annotated/*.json`)
